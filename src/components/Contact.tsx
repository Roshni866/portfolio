...
export default function Contact() {
  ...
  const inputCls = `w-full bg-dark border border-border rounded-xl px-4 py-3 text-[var(--text-primary)] font-mono text-sm
    ...
    <section id="contact" className="py-24 px-6 relative" ref={ref}>
      ...
      <div className={`max-w-5xl mx-auto relative z-10 transition-all duration-700 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
        <div className="mb-14">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-[var(--text-primary)] mb-3 tracking-tight">Get In Touch</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-10">
            ...
            <form onSubmit={submit} className="p-6 space-y-5">
              <div>
                <label className="block text-xs font-mono text-muted mb-2">
                  <span className="text-blue-DEFAULT">$</span> name
                </label>
              ...
              <div>
                <label className="block text-xs font-mono text-muted mb-2">
                  <span className="text-blue-DEFAULT">$</span> email
                </label>
              ...
              <div>
                <label className="block text-xs font-mono text-muted mb-2">
                  <span className="text-blue-DEFAULT">$</span> message
                </label>
              ...
              <button type="submit"
                className="w-full py-3 font-mono rounded-xl transition-all duration-300 font-semibold text-white"
                style={sent
                  ? { background: '#16a34a' }
                  : { background: '#2563eb', boxShadow: '0 0 20px rgba(37,99,235,0.25)' }}
                onMouseEnter={e => { if (!sent) e.currentTarget.style.background = '#1d4ed8' }}
                onMouseLeave={e => { if (!sent) e.currentTarget.style.background = '#2563eb' }}>
          ...
          <div className="space-y-5">
            ...
            <div className="bg-surface/70 border border-blue-DEFAULT/30 rounded-2xl p-6 backdrop-blur-md"
              ...
              <div className="flex gap-3">
                <a href="/resume.pdf" download="Roshni_Bagga_Resume.pdf"
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-3.5
                    font-mono text-sm font-semibold rounded-xl text-white transition-all duration-200 group"
                ...
                <a href="/resume.pdf" target="_blank" rel="noreferrer"
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-3.5
                    font-mono text-sm rounded-xl transition-all duration-200"
              ...
              <p className="text-muted/50 text-xs font-mono mt-3 text-center">last updated · June 2026</p>
            </div>
            ...
            <div className="bg-surface/70 border border-border rounded-2xl p-6 backdrop-blur-md">
              ...
              <div className="space-y-3 font-mono text-sm">
                <p className="text-muted"><span className="text-blue-DEFAULT">name</span> › <span className="text-[var(--text-primary)]">Roshni Bagga</span></p>
                <p className="text-muted"><span className="text-blue-DEFAULT">location</span> › <span className="text-[var(--text-primary)]">Patiala, Punjab, India</span></p>
                <p className="text-muted"><span className="text-blue-DEFAULT">phone</span> › <span className="text-[var(--text-primary)]">+91 9801785410</span></p>
            ...
            <div className="bg-surface/50 border border-border/60 rounded-2xl p-5 font-mono text-sm backdrop-blur-md">
              ...
              <p className="text-[var(--text-primary)]">AI/ML · Data Products · Full Stack · Open Source</p>
            </div>
          </div>
        </div>
      </div>
