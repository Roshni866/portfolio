    ...
    <footer className="relative border-t border-border overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 pt-14 pb-8">
        <div className="grid sm:grid-cols-3 gap-10 mb-12">
          <div>
            <p className="font-mono font-bold text-white text-xl mb-3">
              ...
              {SOCIAL.map(s => (
                <a key={s.name} href={s.url} target="_blank" rel="noreferrer"
                  className="flex items-center gap-2 px-3 py-2 rounded-xl border border-border text-muted
                    hover:text-white hover:border-blue-DEFAULT/50 hover:bg-blue-DEFAULT/8 transition-all duration-200 group">
